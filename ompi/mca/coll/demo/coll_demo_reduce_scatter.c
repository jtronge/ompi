 ...
 */
int mca_coll_demo_reduce_scatter_intra(const void *sbuf, void *rbuf, ompi_count_array *rcounts,
 ...
 *	Returns:	- MPI_SUCCESS or error code
 */
int mca_coll_demo_reduce_scatter_inter(const void *sbuf, void *rbuf, ompi_count_array *rcounts,
                                       struct ompi_datatype_t *dtype,
                                       struct ompi_op_t *op,
                                       struct ompi_communicator_t *comm,
                                       mca_coll_base_module_t *module)
