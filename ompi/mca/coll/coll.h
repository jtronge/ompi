...
typedef int (*mca_coll_base_module_alltoallv_fn_t)
  (const void *sbuf, ompi_count_array *scounts, ompi_disp_array *sdisps, struct ompi_datatype_t *sdtype,
   void *rbuf, ompi_count_array *rcounts, ompi_disp_array *rdisps, struct ompi_datatype_t *rdtype,
   struct ompi_communicator_t *comm, struct mca_coll_base_module_3_0_0_t *module);
typedef int (*mca_coll_base_module_alltoallw_fn_t)
  (const void *sbuf, ompi_count_array *scounts, ompi_disp_array *sdisps, struct ompi_datatype_t * const *sdtypes,
...
typedef int (*mca_coll_base_module_scatterv_fn_t)
  (const void *sbuf, ompi_count_array *scounts, ompi_disp_array *disps, struct ompi_datatype_t *sdtype,
   void* rbuf, size_t rcount, struct ompi_datatype_t *rdtype,
   int root, struct ompi_communicator_t *comm, struct mca_coll_base_module_3_0_0_t *module);
