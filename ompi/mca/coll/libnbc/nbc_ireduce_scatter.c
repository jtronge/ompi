...
static int nbc_reduce_scatter_init(const void* sendbuf, void* recvbuf, ompi_count_array *recvcounts, MPI_Datatype datatype,
...
static int nbc_reduce_scatter_inter_init (const void* sendbuf, void* recvbuf, ompi_count_array *recvcounts, MPI_Datatype datatype,
                                          MPI_Op op, struct ompi_communicator_t *comm, ompi_request_t ** request,
                                          mca_coll_base_module_t *module, bool persistent) {
