...
static int
mca_coll_basic_neighbor_alltoallv_cart(const void *sbuf, ompi_count_array *scounts, ompi_disp_array *sdisps,
...
static int
mca_coll_basic_neighbor_alltoallv_graph(const void *sbuf, ompi_count_array *scounts, ompi_disp_array *sdisps,
                                        struct ompi_datatype_t *sdtype, void *rbuf, ompi_count_array *rcounts,
                                        ompi_disp_array *rdisps, struct ompi_datatype_t *rdtype,
                                        struct ompi_communicator_t *comm, mca_coll_base_module_t *module)
{
...
static int
mca_coll_basic_neighbor_alltoallv_dist_graph(const void *sbuf, ompi_count_array *scounts, ompi_disp_array *sdisps,
                                             struct ompi_datatype_t *sdtype, void *rbuf, ompi_count_array *rcounts,
                                             ompi_disp_array *rdisps, struct ompi_datatype_t *rdtype,
                                             struct ompi_communicator_t *comm, mca_coll_base_module_t *module)
{
