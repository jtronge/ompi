...
extern int mca_coll_monitoring_alltoallv(const void *sbuf, ompi_count_array *scounts,
...
extern int mca_coll_monitoring_alltoallw(const void *sbuf, ompi_count_array *scounts,
                                         ompi_disp_array *sdisps,
...
extern int mca_coll_monitoring_scatterv(const void *sbuf, ompi_count_array *scounts, ompi_disp_array *disps,
                                        struct ompi_datatype_t *sdtype,
                                        void *rbuf, size_t rcount,
                                        struct ompi_datatype_t *rdtype,
                                        int root,
...
extern int mca_coll_monitoring_ialltoallv(const void *sbuf, ompi_count_array *scounts,
                                          ompi_disp_array *sdisps,
                                          struct ompi_datatype_t *sdtype,
                                          void *rbuf, ompi_count_array *rcounts,
                                          ompi_disp_array *rdisps,
...
extern int mca_coll_monitoring_ialltoallw(const void *sbuf, ompi_count_array *scounts,
                                          ompi_disp_array *sdisps,
                                          struct ompi_datatype_t * const *sdtypes,
                                          void *rbuf, ompi_count_array *rcounts,
                                          ompi_disp_array *rdisps,
...
extern int mca_coll_monitoring_iscatterv(const void *sbuf, ompi_count_array *scounts, ompi_disp_array *disps,
                                         struct ompi_datatype_t *sdtype,
                                         void *rbuf, size_t rcount,
                                         struct ompi_datatype_t *rdtype,
                                         int root,
...
extern int mca_coll_monitoring_neighbor_allgatherv(const void *sbuf, size_t scount,
                                                   struct ompi_datatype_t *sdtype, void * rbuf,
                                                   ompi_count_array *rcounts, ompi_disp_array *disps,
                                                   struct ompi_datatype_t *rdtype,
                                                   struct ompi_communicator_t *comm,
                                                   mca_coll_base_module_t *module);
...
extern int mca_coll_monitoring_neighbor_alltoallv(const void *sbuf, ompi_count_array *scounts,
                                                  ompi_disp_array *sdisps,
                                                  struct ompi_datatype_t *sdtype,
                                                  void *rbuf, ompi_count_array *rcounts,
                                                  ompi_disp_array *rdisps,
...
extern int mca_coll_monitoring_neighbor_alltoallw(const void *sbuf, ompi_count_array *scounts,
                                                  ompi_disp_array *sdisps,
                                                  struct ompi_datatype_t * const *sdtypes,
                                                  void *rbuf, ompi_count_array *rcounts,
                                                  ompi_disp_array *rdisps,
...
extern int mca_coll_monitoring_ineighbor_alltoallv(const void *sbuf, ompi_count_array *scounts,
                                                   ompi_disp_array *sdisps,
                                                   struct ompi_datatype_t *sdtype,
                                                   void *rbuf, ompi_count_array *rcounts,
                                                   ompi_disp_array *rdisps,
...
extern int mca_coll_monitoring_ineighbor_alltoallw(const void *sbuf, ompi_count_array *scounts,
                                                   ompi_disp_array *sdisps,
                                                   struct ompi_datatype_t * const *sdtypes,
                                                   void *rbuf, ompi_count_array *rcounts,
                                                   ompi_disp_array *rdisps,
