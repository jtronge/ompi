...
int mca_coll_self_alltoall_intra(const void *sbuf, size_t scount,
                                 ...
                                 struct ompi_communicator_t *comm,
                                 mca_coll_base_module_t *module);
int mca_coll_self_alltoallv_intra(const void *sbuf, ompi_count_array *scounts, ompi_disp_array *sdisps,
                                  struct ompi_datatype_t *sdtype,
                                  void *rbuf, ompi_count_array *rcounts, ompi_disp_array *rdisps,
                                  struct ompi_datatype_t *rdtype,
                                  struct ompi_communicator_t *comm,
                                  mca_coll_base_module_t *module);
int mca_coll_self_alltoallw_intra(const void *sbuf, ompi_count_array *scounts, ompi_disp_array *sdisps,
...
int mca_coll_self_scatter_intra(const void *sbuf, size_t scount,
                                ...
                                int root, struct ompi_communicator_t *comm,
                                mca_coll_base_module_t *module);
int mca_coll_self_scatterv_intra(const void *sbuf, ompi_count_array *scounts, ompi_disp_array *disps,
                                 struct ompi_datatype_t *sdtype,
                                 void* rbuf, size_t rcount,
                                 struct ompi_datatype_t *rdtype, int root,
                                 struct ompi_communicator_t *comm,
